...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (lines.Length == 1)
            {
                logger.LogWarning("Insufficient items in file for comparison");
            }
            ...
            logger.LogInfo($"The furthest Taco Bells are {tacoBell1.Name} and {tacoBell2.Name}, and they are {distance} away from each other.");
